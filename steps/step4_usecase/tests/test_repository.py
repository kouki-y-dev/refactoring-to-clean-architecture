...
ProductRepository, CartRepository, OrderRepository の
保存、取得、検索、削除、初期化などの振る舞いを検証します。
"""
...
class TestProductRepository:
    ...
    def test_find_by_id_exists(self, product_repo: ProductRepository) -> None:
        """存在する商品IDで商品が取得できること."""
    ...
    def test_save_new_product(self, product_repo: ProductRepository) -> None:
        """新規商品が保存されること."""
...
class TestCartRepository:
    ...
    def test_empty_initialization(self, cart_repo: CartRepository) -> None:
        """初期状態でカートが存在しないこと."""
    ...
    def test_save_cart(self, cart_repo: CartRepository) -> None:
        """カートを保存できること."""
    ...
    def test_delete_cart(self, cart_repo: CartRepository) -> None:
        """カートを削除できること."""
        cart = cart_repo.get_or_create("user1")
        cart.add_item("P001", 1)
        cart_repo.save(cart)
    ...
    def test_delete_nonexistent_cart(self, cart_repo: CartRepository) -> None:
...
class TestOrderRepository:
    ...
    def test_empty_initialization(self, order_repo: OrderRepository) -> None:
        """初期状態で注文が0件であること."""
    ...
    def test_save_and_find_by_id(self, order_repo: OrderRepository) -> None:
        """注文の保存とID検索ができること."""
        order = Order.create(
            order_id="ORD-0001",
            user_id="user1",
    ...
    def test_find_by_id_not_found(self, order_repo: OrderRepository) -> None:
        """存在しない注文IDで None が返ること."""
        assert order_repo.find_by_id("ORD-9999") is None

    def test_find_by_user_id(self, order_repo: OrderRepository) -> None:
    ...
    def test_next_order_id(self, order_repo: OrderRepository) -> None:
        """注文IDの採番が正しく行われること."""
