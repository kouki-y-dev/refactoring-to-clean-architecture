"""Step 3: CLI 層 (Presentation Layer) のテスト.
...
class TestListProducts:
    ...
    def test_displays_all_products(
        self, shop_service: ShopService, capsys: pytest.CaptureFixture[str]
    ) -> None:
        """全商品が正しくフォーマットされて表示されること."""
        cli = CLI(service=shop_service)
        cli.list_products()
...
class TestViewCart:
    ...
    def test_displays_cart_with_totals(
        ...
        shop_service.add_item_to_cart("user1", "P003", 3)
